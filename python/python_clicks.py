...
def getClicksReport(api, AccountId):
	startdate = '2014-10-13T00:00:00.000Z'
	enddate = '2014-10-14T00:00:00.000Z'
	report = api.reports.easysmtp_clicks(AccountId=AccountId, startdate=startdate, enddate=enddate)
	if report[0] == 200:
		return report[1] 
	else:
...
def run():
	...
	res=getClicksReport(api, AccountId)
